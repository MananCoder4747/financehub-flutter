    ...
    return Scaffold(
      body: Container(
        decoration: const BoxDecoration(
          gradient: LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF1e1b4b), Color(0xFF312e81), Color(0xFF4c1d95)]),
        ),
        child: SafeArea(
          child: Center(
        ...
        child: Column(children: [
          ...
          Expanded(
            child: PageView(
              ...
              children: [DashboardTab(onNavigate: navigateToTab), const TransactionsTab(type: 'lend'), const TransactionsTab(type: 'borrow'), const PeopleTab()],
            ),
          ),
        ]),
      ),
        ...
        child: SafeArea(
          child: Padding(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceAround, children: [
              _NavItem(icon: Icons.dashboard_rounded, label: 'Dashboard', active: _currentIndex == 0, onTap: () => navigateToTab(0)),
              _NavItem(icon: Icons.arrow_upward_rounded, label: 'Lent', active: _currentIndex == 1, color: AppColors.success, onTap: () => navigateToTab(1)),
              _NavItem(icon: Icons.arrow_downward_rounded, label: 'Borrowed', active: _currentIndex == 2, color: AppColors.danger, onTap: () => navigateToTab(2)),
              _NavItem(icon: Icons.people_rounded, label: 'People', active: _currentIndex == 3, onTap: () => navigateToTab(3)),
            ]),
          ),
        ),
      ),
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              GridView.count(
                ...
                children: [
                  ...
                  _StatCard(icon: Icons.pending_actions_rounded, label: 'Pending', value: '$pendingCount', color: AppColors.warning, onTap: () {}),
                ],
              ),
        ...
        if (showActions) ...[
          ...
          Row(children: [
            Expanded(child: OutlinedButton.icon(
              onPressed: () => showTransactionDialog(context, transaction: transaction, isEdit: true),
            ...
            const SizedBox(width: 8),
            if (isPending) Expanded(child: OutlinedButton.icon(
...
void showTransactionDialog(BuildContext context, {String? type, Map<String, dynamic>? transaction, bool isEdit = false}) {
  ...
  final isLend = selectedType == 'lend';
        ...
        child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Row(children: [
            Container(
              ...
              decoration: BoxDecoration(color: (currentIsLend ? AppColors.success : AppColors.danger).withOpacity(0.15), borderRadius: BorderRadius.circular(12)),
              child: Icon(currentIsLend ? Icons.arrow_upward_rounded : Icons.arrow_downward_rounded, color: currentIsLend ? AppColors.success : AppColors.danger),
            ),
            const SizedBox(width: 12),
            ...
            Row(children: [
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(color: selectedType == 'lend' ? AppColors.success.withOpacity(0.2) : Colors.transparent, borderRadius: BorderRadius.circular(10), border: Border.all(color: selectedType == 'lend' ? AppColors.success : AppColors.border)),
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Icon(Icons.arrow_upward_rounded, color: selectedType == 'lend' ? AppColors.success : AppColors.textSecondary, size: 18),
                    const SizedBox(width: 6),
                    Text('Lend', style: TextStyle(color: selectedType == 'lend' ? AppColors.success : AppColors.textSecondary, fontWeight: FontWeight.w600)),
                  ]),
                ),
              )),
              const SizedBox(width: 12),
              Expanded(child: GestureDetector(
                ...
                child: Container(
                  padding: const EdgeInsets.symmetric(vertical: 12),
                  decoration: BoxDecoration(color: selectedType == 'borrow' ? AppColors.danger.withOpacity(0.2) : Colors.transparent, borderRadius: BorderRadius.circular(10), border: Border.all(color: selectedType == 'borrow' ? AppColors.danger : AppColors.border)),
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Icon(Icons.arrow_downward_rounded, color: selectedType == 'borrow' ? AppColors.danger : AppColors.textSecondary, size: 18),
                    const SizedBox(width: 6),
                    Text('Borrow', style: TextStyle(color: selectedType == 'borrow' ? AppColors.danger : AppColors.textSecondary, fontWeight: FontWeight.w600)),
                  ]),
                ),
              )),
            ]),
